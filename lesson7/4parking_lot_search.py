...
Your task is to maneuver a car in a crowded parking lot. This is a kind of puzzle, which
can be represented with a diagram like this:
...
#       path = solve_actions(path) == [('A', -3), ('B', 16), ('Y', 24), ('*', 4)]
...
def solve_parking_puzzle(start, N=N):
    ...
    return shortest_path_search(grid(start, N), start, psuccessors, is_goal)
...
def psuccessors(state):
    ...
    where action is of form ('c', dir), where dir is +/- or +/-N.
    """
    results = {}
