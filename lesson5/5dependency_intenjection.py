...
def test():
    for _ in range(10):
        winner1 = play_pig(always_hold, always_roll)
        assert winner1.__name__ == 'always_roll'

        winner2 = play_pig(always_roll, always_hold)
        assert winner2.__name__ == 'always_roll'
    return 'tests pass'
...
def test2():
    ...
    rolls = iter([6, 6, 6, 6, 6, 6, 6, 6, 6, 2])
